...
public class BlueCloseAutonomous extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory center3 = drive.trajectoryBuilder(center2.end())
                ...
                .splineTo(new Vector2d(-66,15), Math.toRadians(178),
        ...
        Trajectory left1 = drive.trajectoryBuilder(startPose)
                .splineToLinearHeading(new Pose2d(31, 32, Math.toRadians(180)), Math.toRadians(180))
                .addTemporalMarker(1.5 , () -> {
                    intake.setPower(-0.3);
                    leftClaw.setPosition(1);
                    sleep(100);
        ...
        Trajectory right1 = drive.trajectoryBuilder(startPose)
                .splineToLinearHeading(new Pose2d(9, 34, Math.toRadians(180)), Math.toRadians(180))
                .addTemporalMarker(1.5 , () -> {
                    intake.setPower(-0.3);
                    leftClaw.setPosition(1);
                    sleep(100);
