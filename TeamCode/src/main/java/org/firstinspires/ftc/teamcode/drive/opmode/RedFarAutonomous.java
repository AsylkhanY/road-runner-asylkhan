...
public class RedFarAutonomous extends LinearOpMode {
    ...
    float backdropCenter = -37.5f;
    //ITS RIIIIGHHHHTTT
    float backdropLeft = -46.5f;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory center10 = drive.trajectoryBuilder(center7.end())
                //.splineToConstantHeading(new Vector2d(55, 41.5), Math.toRadians(0))
                .forward(6)
                .splineToConstantHeading(new Vector2d(44, backdropCenter - 20), Math.toRadians(-180))
                .build();
        ...
        Trajectory left8 = drive.trajectoryBuilder(left7.end())
                //.splineToConstantHeading(new Vector2d(55, 41.5), Math.toRadians(0))
                .forward(6)
                .splineToConstantHeading(new Vector2d(44, backdropRight - 30), Math.toRadians(-180))
                .build();

        Trajectory right1 = drive.trajectoryBuilder(startPose)
                .splineTo(new Vector2d(-35, -34), Math.toRadians(0))
                .build();
        ...
        Trajectory right8 = drive.trajectoryBuilder(right7.end())
                //.splineToConstantHeading(new Vector2d(55, 41.5), Math.toRadians(0))
                .forward(6)
                .splineToConstantHeading(new Vector2d(44, backdropLeft - 15), Math.toRadians(-180))
                .build();
